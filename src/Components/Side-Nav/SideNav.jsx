...
const SideNav = () => {
  ...
  const openFeedback = () => {
    ...
    const url = 'https://docs.google.com/forms/d/1SRhkUmtsl_agb9QzW204w2gkbmvrUybnuAoK9gKwUJA/edit?usp=drive_link';
  ...
  return (
    <div>
      ...
      <div ref={navRef} className={`side-nav ${isNavOpen ? '' : 'closed'}`}>
        <img src="/images/stackroute.png" alt="Stackroute Logo" style={{ width: '50%', height: 'auto' }} />
        <p>v1.0.1</p>
